...
def trans(file_name):    
    source_file_path = 'uploads/' + file_name
    source_filename_without_extension = os.path.splitext(file_name)[0]
    document = Document()
    ...
    ###########################################################################################################
    # translate table
    output_filename = source_filename_without_extension + '_trans_result.docx'
