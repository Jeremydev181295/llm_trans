...
def build_trans_prompt(source_lang, trans_lang, data):    
    ...
    prompts = [f"Translate '{string.strip()}' from {source_lang} into {trans_lang}. I need only translation string. Do not translate numbers and symbols and abbreviation. Keep original style. Keep dash and colon. Do not mention others." for string in data]
